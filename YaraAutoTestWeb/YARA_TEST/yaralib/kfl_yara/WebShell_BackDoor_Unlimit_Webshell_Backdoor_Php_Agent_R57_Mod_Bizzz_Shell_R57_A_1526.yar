rule WebShell_BackDoor_Unlimit_Webshell_Backdoor_Php_Agent_R57_Mod_Bizzz_Shell_R57_A_1526 {
  meta:
    author = "Spider"
    comment = "None"
    date = "2016-01-11"
    ...
    score = 70
    threatname = "WebShell[BackDoor]/Unlimit.Webshell.Backdoor.Php.Agent.R57.Mod.Bizzz.Shell.R57.A"
    threattype = "BackDoor"
  strings:
