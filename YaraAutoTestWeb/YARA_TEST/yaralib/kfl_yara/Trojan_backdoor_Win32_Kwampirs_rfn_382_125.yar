rule Trojan_backdoor_Win32_Kwampirs_rfn_382_125
{
    meta:
        judge = "black"
        threatname = "Trojan[backdoor]/Win32.Kwampirs.rfn"
        threattype = "backdoor"
        family = "Kwampirs"
        hacker = "None"
        author = "mqx"
        refer = "5C3499ACFE0AD7563B367FBF7FB2928C,290D8E8524E57783E8CC1B9A3445DFE9,939E76888BDEB628405E1B8BE963273C"
        comment = "None"
        date = "2018-06-20"
