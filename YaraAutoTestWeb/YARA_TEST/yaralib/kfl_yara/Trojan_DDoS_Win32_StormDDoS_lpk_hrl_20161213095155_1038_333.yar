rule Trojan_DDoS_Win32_StormDDoS_lpk_hrl_20161213095155_1038_333 
{
	meta:
		judge = "black"
		threatname = "Trojan[DDoS]/Win32.StormDDoS.lpk_hrl"
		threattype = "DDOS"
		family = "StormDDoS"
		hacker = "None"
		...
		date = "2016-09-01"
	strings:
		$s0 = "Registry\\Machine\\System\\CurrentControlSet\\Control\\SecurePipeServers"
		$s1 = "Nationalivd"
		$s2 = "LpkDllInitialize"
		$s3 = "SetServiceStatus"
		$s4 = "SetSecurityDescriptorDacl"
