rule Trojan_Dropper_Win32_POSBernhard_ch_865_374
{
    meta:
        judge = "black"
        threatname = "Trojan[Dropper]/Win32.POSBernhard.ch"
        threattype = "Dropper"
        family = "POSBernhard"
        hacker = "None"
        author = "copy"
        refer = "e49820ef02ba5308ff84e4c8c12e7c3d"
        comment = "http://morphick.com/blog/2015/7/14/bernhardpos-new-pos-malware-discovered-by-morphick"
        date = "2018-11-05"
