rule WebShell_BackDoor_Unlimit_Webshell_404_Data_In_Jfolder_Jfolder01_Jsp_Suiyue_Warn_A_1483 {
  meta:
    author = "Spider"
    comment = "None"
    date = "2014/01/28"
    ...
    score = 70
    super_rule = 1
    threatname = "WebShell[BackDoor]/Unlimit.Webshell.404.Data.In.Jfolder.Jfolder01.Jsp.Suiyue.Warn.A"
    threattype = "BackDoor"
  strings:
