rule WebShell_BackDoor_Unlimit_Webshell_Jspspy_Jspspyjdk5_Jspspyjdk51_Luci_Jsp_Spy2009_M_Ma3_Xxx_A_1627 {
  meta:
    author = "Spider"
    comment = "None"
    date = "2014/01/28"
    ...
    score = 70
    super_rule = 1
    threatname = "WebShell[BackDoor]/Unlimit.Webshell.Jspspy.Jspspyjdk5.Jspspyjdk51.Luci.Jsp.Spy2009.M.Ma3.Xxx.A"
    threattype = "BackDoor"
  strings:
