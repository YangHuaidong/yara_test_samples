rule Trojan_HACKTOOL_Win32_Powerstager_a_776_539
{
    meta:

        judge = "black"
        threatname = "Trojan[HACKTOOL]/Win32.Powerstager.a"
        threattype = "HACKTOOL"
        family = "Powerstager"
        hacker = "None"
        refer = "b5d858a934b007f8818cf80e90d21630,c6d3b8211db8329ae97ba3b8b8ed9f4c"
        comment = "None"
        author = "Jeff White - jwhite@paloaltonetworks.com @noottrak -lz"
        date = "02JAN2018" 
